...
- Comment and work stats scraping reuse the Chrome tabs they create across works, avoid bringing Chrome to the foreground, and close those tabs after the queue finishes.
